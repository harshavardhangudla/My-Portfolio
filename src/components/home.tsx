  ...
  const projects = [
    {
      ...
      description:
        "Built a business-facing CRM system that automates sales, inventory, and billing workflows.",
      technologies: ["Salesforce CRM"],
      githubLink:
        "https://github.com/harshavardhangudla/A-CRM-APPLICATION-FOR-WHOLESALE-RICE-MILL.git",
      demoLink: "",
    },
    {
      title: "MNIST Digit Classifier",
      description:
        "Developed using Python and Neural Networks to classify handwritten digits.",
      technologies: ["Python", "Neural Networks", "Deep Learning"],
      githubLink: "",
      demoLink: "",
    },
    {
      title: "Web Mini Projects",
      description:
        "Built personal portfolio, e-commerce landing page, and calculator using HTML, CSS, JavaScript.",
  ...
  return (
    <div className="bg-background min-h-screen">
          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className="flex gap-4">
                <Button asChild>
                  <a
                    href="https://drive.google.com/file/d/1LVal-xPN0_kvP-Dj4UrVqcnBCH0VP6e8/view?usp=sharing"
                    target="_blank"
      ...
      <SectionContainer
        id="education"
        ref={educationRef}
        className="min-h-screen flex items-center py-16 bg-gradient-to-b from-background to-primary/5"
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
      ...
      <SectionContainer
        id="experience"
        ref={experienceRef}
        className="min-h-screen flex items-center py-16 bg-gradient-to-b from-primary/5 to-background"
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
